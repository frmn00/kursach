...
( HWND hWnd, UINT uiMessage, WPARAM wParam, LPARAM lParam )
{
	...
	switch(uiMessage)
        { case WM_LBUTTONDOWN: pWndData->mouseb|=1; break;
	  case WM_LBUTTONUP: pWndData->mouseb&=~1; break;
          case WM_RBUTTONDOWN: pWndData->mouseb|=2; break;
	  case WM_RBUTTONUP: pWndData->mouseb&=~2; break;
